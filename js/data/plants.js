...
export const plantData = {
    ...
    hinoki: {
        ...
        description: `
            你不一定愛說話，但會把該做的事情做完。<br><br>
            你在乎承諾、重視穩定，也願意為了重要的人多撐一點。<br>
            有時候你會忘記自己也會累，還是習慣先照顧好大家。<br><br>
    ...
    chamomile: {
        ...
        description: `
            你很會照顧人，也很懂得感受細微的情緒變化。<br><br>
            你喜歡讓身邊的人感到被理解、被接住，<br>
            但久了會發現：自己好像很少被好好照顧。<br><br>
    ...
    mint: {
        ...
        description: `
            你不喜歡停滯，也不太能忍受原地踏步。<br><br>
            一旦有方向，你就會很快行動、很快調整。<br>
            只是有時候，往前衝也會讓你忘記「自己其實已經累了」。<br><br>
    ...
    peony: {
        ...
        description: `
            你對人生有畫面，也在意生活要有一點漂亮和氣勢。<br><br>
            你喜歡被看見、被肯定，卻也會在沒人懂你的時候突然跌到谷底。<br>
            情緒對你來說很真實，你愛、你喜歡、你失望，都非常明顯。<br><br>
